...
echo "delete mssql...."
kubectl delete -f ./kubernetes/mssql.yaml

##########################

echo "delete the persistent volume for mssql...."
kubectl delete -f ./kubernetes/mssql-local-pv.yaml
rm -rf /Users/Shared/Kubernetes/persistent-volumes/default/mssql
