...
echo "setup the persistent volume for mssql...."
mkdir -p /Users/Shared/Kubernetes/persistent-volumes/default/mssql
kubectl apply -f ./kubernetes/mssql-local-pv.yaml

##########################

echo "deploy mssql...."
kubectl apply -f ./kubernetes/mssql.yaml
